				...
				<>
					<div class="relative min-h-screen px-24 py-8 flex items-center justify-center">
						...
						<div class="w-9/12 flex flex-col items-center">
							<p class="mb-8 font-inter text-zinc-500 text-sm text-center tracking-wider">
								THIS PAGE HAS BEEN BLOCKED.
							</p>
							<p class="mb-4 font-hedvig text-2xl text-center">
								"{quote().quote}"
							</p>
							<p class="mb-8 font-hedvig text-zinc-500 text-lg text-center">
								~{quote().author}
							</p>
						</div>
					</div>
